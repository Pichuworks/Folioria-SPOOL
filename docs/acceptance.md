...
|---|---|---|---|---|---|---|
| A | 6 C850彩图·单 | 6 哑光铜版纸 | A3 | 56 | 16 | 72 |
| B | 1 C850黑白·单 | 1 亚太森博 A4 | A4 | 3 | 3 | 6 |
| C | 7 P708原装(set) | 11 RC艺术纸 | A3 | 2273 | 246 | 2519 |
| D | 6 C850彩图·单 | 8 不干胶光面 | A4 | 28 | 29 | 57 |

（C 验证 set 计价：eff=250000_c；ml 计价用 mode 8 P708灌装：eff=100×1000=100000_c。
D40 口径：旧 `index.html` 表格里的 P708 低成本区间只对应灌装模式，不覆盖 P708 原装模式；C850 按 T01 CMYK 套装 140000_c，G580/L15168 按墨水套装 25000_c，seed 里已按保守产量摊销。）
...
|---|---|---|---|---|
| 黑白×亚太森博 A4 | 7 | 19 | **7** | below_margin（橙） |
| 彩图×哑光铜版纸 A3 | 90 | 219 | **90** | below_margin |
| P708原装×RC艺术纸 A3 | 2500 | 7634 | **2500** | LOSS（红，sell<total） |
| 黑白×金华盛 A4 | 无 | 31 | 31 | auto |

force_min_margin = ON：黑白×亚太森博 A4 → sell_c=19，标记 forced。
